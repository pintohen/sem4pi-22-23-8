...
class ViewBoardHistoryControllerTest {
    ...
    private ViewBoardHistoryController viewBoardHistoryController;
    ...
    public void setUp() {
        ...
        viewBoardHistoryController = new ViewBoardHistoryController(boardRepository, postItRepository);
    }
    ...
    public void getLastPostItsByBoard() {
        ...
        when(postItRepository.getPostItsHistory(board)).thenReturn(new ArrayList<>());

        viewBoardHistoryController.viewBoardHistory(1L, authUser);

        verify(boardRepository, times(1)).ofIdentity(1L);
        verify(postItRepository, times(1)).getPostItsHistory(board);
    }
    ...
    public BoardPermission createBoardPermission(User user){
        ...
        return factory.create(user, AccessLevelType.WRITE);
    }
